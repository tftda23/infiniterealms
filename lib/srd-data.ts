...
export const SRD_ITEMS: SRDItem[] = [
  ...
  // ── Light Armor ──
  {
    ...
    type: 'armor',
    rarity: 'common',
    description: 'Quilted layers of cloth and batting. AC 11 + DEX mod.',
    armorClass: 11,
    properties: ['light', 'disadvantage on stealth'],
    value: '5 gp',
  },
  {
    name: 'Leather Armor',
    type: 'armor',
    rarity: 'common',
    description: 'Light armor made of hardened leather. AC 11 + DEX mod.',
    armorClass: 11,
    properties: ['light'],
    value: '10 gp',
  },
  {
    ...
    type: 'armor',
    rarity: 'common',
    description: 'Leather reinforced with rivets and spikes. AC 12 + DEX mod.',
    armorClass: 12,
    properties: ['light'],
    value: '45 gp',
  },
  // ── Medium Armor ──
  {
    ...
    type: 'armor',
    rarity: 'common',
    description: 'Crude armor made from thick animal hides. AC 12 + DEX mod (max 2).',
    armorClass: 12,
    properties: ['medium'],
    value: '10 gp',
  },
  {
    ...
    type: 'armor',
    rarity: 'common',
    description: 'A shirt of interlocking metal rings worn under clothing. AC 13 + DEX mod (max 2).',
    armorClass: 13,
    properties: ['medium'],
    value: '50 gp',
  },
  {
    ...
    type: 'armor',
    rarity: 'common',
    description: 'Coat and leggings of leather covered with overlapping metal scales. AC 14 + DEX mod (max 2).',
    armorClass: 14,
  ...
  },
  {
    ...
    type: 'armor',
    rarity: 'common',
    description: 'A fitted metal chest piece with leather fittings. AC 14 + DEX mod (max 2).',
    armorClass: 14,
    properties: ['medium'],
    value: '400 gp',
  },
  ...
  // ── Heavy Armor ──
  {
    ...
    type: 'armor',
    rarity: 'common',
    description: 'Leather armor with heavy rings sewn into it. AC 14.',
    armorClass: 14,
  ...
  },
  {
    ...
    type: 'armor',
    rarity: 'common',
    description: 'Interlocking metal rings forming a mesh. AC 16. Requires STR 13.',
    armorClass: 16,
    properties: ['heavy', 'disadvantage on stealth', 'str 13'],
    value: '75 gp',
  },
  {
    name: 'Splint Armor',
    type: 'armor',
    rarity: 'common',
    description: 'Narrow vertical metal strips riveted to a leather backing. AC 17. Requires STR 15.',
    armorClass: 17,
    properties: ['heavy', 'disadvantage on stealth', 'str 15'],
    value: '200 gp',
  },
  {
    name: 'Plate Armor',
    type: 'armor',
    rarity: 'common',
    description: 'Full-body armor of shaped, interlocking metal plates. AC 18. Requires STR 15.',
    armorClass: 18,
    properties: ['heavy', 'disadvantage on stealth', 'str 15'],
    value: '1500 gp',
  },
  {
    ...
    type: 'armor',
    rarity: 'common',
    description: 'A protective barrier wielded in one hand. +2 AC.',
    armorClass: 2,
    properties: ['off-hand'],
    value: '10 gp',
  },
